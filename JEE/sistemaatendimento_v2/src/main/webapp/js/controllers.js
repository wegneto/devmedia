...
crudAtendimento.controller("AtendimentoController", ["$resource", "$scope", function ($resource, $scope) {
            ...
            var angularResource = $resource("/sistemaatendimento_v2/ws/atendimento");
            var angularResourceParam = $resource("/sistemaatendimento_v2/ws/atendimento/:protocolo", {protocolo: "@protocolo"});
            ...
            $scope.excluir = function () {
                var newResource = new angularResourceParam(
                    $scope.atendimento);
                newResource
                    .$delete(function () {
                        $scope.atendimentos
